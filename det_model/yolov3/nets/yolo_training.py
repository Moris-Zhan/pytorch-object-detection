    ...
    def get_target(self, l, targets, anchors, in_h, in_w):
        ...
        for b in range(bs):            
            ...
            for t, best_n in enumerate(best_ns):
                ...
                y_true[b, k, j, i, 2] = math.log(batch_target[t, 2] / anchors[best_n][0]) if batch_target[t, 2] / anchors[best_n][0] > 0 else 0                
                y_true[b, k, j, i, 3] = math.log(batch_target[t, 3] / anchors[best_n][1]) if batch_target[t, 3] / anchors[best_n][1] > 0 else 0
                y_true[b, k, j, i, 4] = 1
