...
from det_model.rtmdet.utils.metrics import box_iou, fitness
...
def check_dataset(data, autodownload=True):
    ...
    # Usage: https://github.com/ultralytics/rtmdet/releases/download/v1.0/coco128_with_yaml.zip
...
def labels_to_class_weights(labels, nc=11):
...
def labels_to_image_weights(labels, nc=11, class_weights=np.ones(11)):
...
def coco80_to_coco91_class():  # converts 11-index (val2014) to 91-index (paper)
...
def strip_optimizer(f='best.pt', s=''):  # from det_model.yolov4.utils.general import *; strip_optimizer()
