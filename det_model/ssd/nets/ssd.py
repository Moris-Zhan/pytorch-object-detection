...
from det_model.ssd.nets.mobilenetv2 import InvertedResidual, mobilenet_v2
from det_model.ssd.nets.vgg import vgg as add_vgg
...
class SSD300(nn.Module):
    ...
    def freeze_backbone(self):
        if self.backbone_name == "vgg":
            for param in self.vgg[:28].parameters():
