...
class LossHistory():
    ...
    def write_summary(self, cpu_model):
        ...
        rndm_input = torch.autograd.Variable(torch.rand(1, 3, 608, 608), requires_grad = False).cpu()
        ...
        with redirect_stdout(f):
            summary(cpu_model, input_size=(1, 3, 608, 608), device="cpu")
        lines = f.getvalue()
