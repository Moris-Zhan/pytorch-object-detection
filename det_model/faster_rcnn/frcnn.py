...
from det_model.faster_rcnn.utils.utils import (cvtColor, get_classes, get_new_img_size, resize_image,
                         preprocess_input)
...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'logs/FasterRCNN/ep050-loss63.300-val_loss2.332.pth', 
        #---------------------------------------------------------------------#
