...
def get_opts(Train=True):
    ...
    #############################################################################################    
    opt.net = 'yolov3'     # [centernet, faster_rcnn, retinanet, ssd, yolov3, yolov4, yolov5, yolox]
    opt.model_path      = 'model_data/weight/yolo3_weights.pth'
    ...
    #------------------------------------------------------#
    opt.anchors_path    = 'det_model/yolov3/yolo_anchors.txt'
    ...
    if Train:
        ...
        from det_model.yolov3.yolo import YOLO
        opt.Model_Pred = YOLO  
    return opt
