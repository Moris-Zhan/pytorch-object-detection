...
from det_model.faster_rcnn.utils.general import LOGGER, check_version, colorstr, resample_segments, segment2box
from det_model.faster_rcnn.utils.metrics import bbox_ioa
...
class Albumentations:
    ...
    def __call__(self, im, labels, p=1.0):
        if self.transform and random.random() < p:
            ...
            im, labels = new['image'], np.array([[*b, c] for c, b in zip(new['class_labels'], new['bboxes'])])
        return im, labels
