...
class LossHistory():
    def __init__(self, model, patience = 5):
        ...
        rndm_input = torch.autograd.Variable(torch.rand(1, 3, 200, 200), requires_grad = False).to(device)
