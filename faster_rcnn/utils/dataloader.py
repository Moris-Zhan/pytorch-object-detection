...
import torch
from det_model.faster_rcnn.utils.utils import cvtColor, preprocess_input
from det_model.faster_rcnn.utils.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
...
class FRCNNDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image, y    = self.get_random_data(index)
