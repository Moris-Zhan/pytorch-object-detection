...
from retinanet.nets.retinanet import retinanet
from retinanet.utils.utils import (cvtColor, get_classes, preprocess_input,
                         resize_image)
from retinanet.utils.utils_bbox import decodebox, non_max_suppression
...
class Retinanet(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'logs/Retinanet/ep050-loss0.782-val_loss0.822.pth',
